...
<body style="font-family: system-ui, sans-serif; line-height: 1.5; color: #1e293b; max-width: 560px; margin: 0 auto; padding: 24px;">
    ...
    <p>
        <strong>{{ $clinica->nombre }}</strong> está solicitando vincular tu historia clínica a su sistema.
    </p>
    ...
    <p style="font-size: 13px; color: #64748b;">
        Este mensaje se envía de forma automática en relación con tu historia clínica en el sistema de la clínica.
    </p>
