...
<body style="font-family: system-ui, sans-serif; line-height: 1.5; color: #1e293b; max-width: 560px; margin: 0 auto; padding: 24px;">
    ...
    @if(($contexto ?? 'registro') === 'nueva_vinculacion')
        <p>
            <strong>{{ $clinicaNombre }}</strong> ha solicitado vincular tu historia clínica a su espacio en el sistema.
        </p>
        <p>
            ...
            y que autorizas que este establecimiento pueda acceder y utilizar la información de tu historia clínica cuando corresponda a tu atención.
        </p>
        <p style="background: #f1f5f9; border-radius: 8px; padding: 14px 16px; font-size: 14px;">
            ...
            vinculados a tu persona hayan compartido en la historia clínica, siempre conforme a la normatividad y a las finalidades informadas en el aviso de privacidad.
        </p>
    @else
        <p>
        ...
        <p style="font-size: 14px; color: #475569;">
            Tu historia clínica puede llegar a incluir estudios, laboratorios, recetas y demás información clínica que el personal autorizado registre conforme a la ley.
        </p>
    @endif
