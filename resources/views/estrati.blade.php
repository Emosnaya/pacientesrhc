    ...
    <main class="mt-1">
      <div class="contenedor ">
        ...
        <div class="m-t-1 mb-0">
          <p class="mb-0  f-bold f-10 m-t-1">Fc Diana :<span class="ml-1 f-normal">{{rounded($data->fc_diana)}} lpm</span> <span class="ml-4 f-bold">Dp Diana: <span class="f-normal">{{$data->dp_diana}} mmHg*lpm</span> </span>  <span class="ml-4 f-bold">Carga Inicial:<span class="ml-3 f-normal"> {{$data->carga_inicial}}Watts</span></span></p>
