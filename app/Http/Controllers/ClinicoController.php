...
class ClinicoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $clinico->clase_f_ccs = $data['claseCcs'];
        ...
        $clinico->betabloqueador = $data['betabloqueador']==="true"?1:0;
        $clinico->nitratos = $data['nitratos']==="true"?1:0;
        $clinico->calcioantagonista = $data['calcioanta']==="true"?1:0;
        $clinico->aspirina = $data['aspirina']==="true"?1:0;
        $clinico->anticoagulacion = $data['anticoagulacion']==="true"?1:0;
        $clinico->iecas = $data['iecas']==="true"?1:0;
        $clinico->atii = $data['atii']==="true"?1:0;
        $clinico->diureticos = $data['diureticos']==="true"?1:0;
        $clinico->estatinas = $data['estatinas']==="true"?1:0;
        $clinico->fibratos = $data['fibratos']==="true"?1:0;
        $clinico->digoxina = $data['digoxina']==="true"?1:0;
        $clinico->antiarritmicos = $data['antiarritmicos']==="true"?1:0;
        $clinico->arni = $data['arni']==="true"?1:0;
        $clinico->sglt2 = $data['sglt2']==="true"?1:0;
        $clinico->mra = $data['mra']==="true"?1:0;
        $clinico->ivabradina = $data['ivabradina']==="true"?1:0;
        $clinico->pcsk0 = $data['pcsk0']==="true"?1:0;
        $clinico->ranalozina = $data['ranalozina']==="true"?1:0;
        $clinico->timetrazidina = $data['timetrazidina']==="true"?1:0;
        $clinico->inhibidor_adp = $data['inhibidor_adp']==="true"?1:0;
        ...
        $clinico->qtc = $data['rrmm']!=null?$data['qtm']/sqrt(60/$clinico->fc_ecog):null;
        $clinico->pr = $data['pr'];
    ...
    public function update(Request $data, Clinico $clinico)
    {
        ...
        $clinico->imInferior = $data['imInferior'];
        $clinico->imdelVD = $data['imdelVD'];
        $clinico->im_post_inferior = $data['im_post_inferior'];
        ...
        $clinico->betabloqueador = $data['betabloqueador']==="true"||$data['betabloqueador']===1?1:0;
        $clinico->nitratos = $data['nitratos']==="true"||$data['nitratos']===1?1:0;
        $clinico->calcioantagonista = $data['calcioantagonista']==="true"||$data['calcioantagonista']===1?1:0;
        $clinico->aspirina = $data['aspirina']==="true"||$data['aspirina']===1?1:0;
        $clinico->anticoagulacion = $data['anticoagulacion']==="true"||$data['anticoagulacion']===1?1:0;
        $clinico->iecas = $data['iecas']==="true"||$data['iecas']===1?1:0;
        $clinico->atii = $data['atii']==="true"||$data['atii']===1?1:0;
        $clinico->diureticos = $data['diureticos']==="true"||$data['diureticos']===1?1:0;
        $clinico->estatinas = $data['estatinas']==="true"||$data['estatinas']===1?1:0;
        $clinico->fibratos = $data['fibratos']==="true"||$data['fibratos']===1?1:0;
        $clinico->digoxina = $data['digoxina']==="true"||$data['digoxina']===1?1:0;
        $clinico->antiarritmicos = $data['antiarritmicos']==="true"||$data['antiarritmicos']===1?1:0;
        $clinico->arni = $data['arni']==="true"||$data['arni']===1?1:0;
        $clinico->sglt2 = $data['sglt2']==="true"||$data['sglt2']===1?1:0;
        $clinico->mra = $data['mra']==="true"||$data['mra']===1?1:0;
        $clinico->ivabradina = $data['ivabradina']==="true"||$data['ivabradina']===1?1:0;
        $clinico->pcsk0 = $data['pcsk0']==="true"||$data['pcsk0']===1?1:0;
        $clinico->ranalozina = $data['ranalozina']==="true"||$data['ranalozina']===1?1:0;
        $clinico->timetrazidina = $data['timetrazidina']==="true"||$data['timetrazidina']===1?1:0;
        $clinico->inhibidor_adp = $data['inhibidor_adp']==="true"||$data['inhibidor_adp']===1?1:0;
