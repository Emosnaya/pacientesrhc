...
{
    /**
     * D�as calendario tras la fecha de vencimiento en los que a�n hay acceso (sin 402).
     * D�a 0 = d�a de vencimiento; d�a 1 = un d�a despu�s. El bloqueo empieza en GRACE_DAYS.
     */
    ...
    /**
     * D�as enteros respecto a la fecha de vencimiento (0 = vence hoy, negativo = ya pas�).
     */
    ...
    public static function getStatus(Clinica $clinica, ?User $user = null): array
    {
        ...
        if ($fechaVencimiento && ! self::fechaVencimientoVigente($fechaVencimiento)) {
            ...
            // Per�odo de gracia: acceso completo los primeros GRACE_DAYS d�as (0 y 1).
            // Banner de vencida en frontend desde d�a 1; modal/402 desde d�a GRACE_DAYS (2).
